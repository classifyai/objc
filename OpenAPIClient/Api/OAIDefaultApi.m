...
-(NSURLSessionTask*) createNewModelWithModelName: (NSString*) modelName
    ...
    if (modelName == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"modelName"] };
...
-(NSURLSessionTask*) indexByImageUrlWithModelId: (NSString*) modelId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/index_by_image_url"];
...
-(NSURLSessionTask*) tagImageByUrlWithModelId: (NSString*) modelId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/predict_by_image_url"];
